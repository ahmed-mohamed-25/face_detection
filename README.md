...
```ruby
platform :ios, '17.0'  # or newer version

...

# add this line:
$iOSVersion = '17.0'  # or newer version
...
Notice that the minimum `IPHONEOS_DEPLOYMENT_TARGET` is 17.0, you can set it to something newer but not older.
